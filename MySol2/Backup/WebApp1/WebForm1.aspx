...
<body>
    <%--<a href="http://www.arqi.cc" style="font-size: 24px;">阿奇arqi关注web，关注前端！网页特效 漂亮的点击弹出的登录窗口
    </a>http://www.arqi.cc--%>
    <hr>
    ...
    <div id="login" style="display: none;">
        ...
        <ul>
            ...
            <li><tt></tt>
                <div>
                    <input id="reme" name="reme" type="checkbox" /><label for="reme">下次自动登录</label>
                </div>
            </li>
            <li><tt></tt>
                <div>
                    <input id="fnlogin" type="button" value="登陆"  onclick="logo_in()"/><a href="#">忘记密码</a></div>
            </li>
            </form>
        </ul>
    </div>
